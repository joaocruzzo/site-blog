...
export const SupportSection = () => {
    return (
        <section className="relative py-12 md:py-[7.5rem] bg-gradient-to-r from-gray-500 to-gray-700">
            <div className="absolute inset-0 hidden md:block bg-[url('/background-support.svg')] bg-cover bg-center bg-no-repeat opacity-90" />
